    ...
    <section className="flex-1 flex flex-col justify-center px-6 py-12 md:px-16 lg:px-24 bg-background relative z-30">
      ...
      <header className="mb-10 max-w-lg">
        ...
        <p className="text-on-surface-variant text-lg md:text-xl font-body leading-relaxed">
          Master the resonance of wood and string. Explore instrument anatomy, technique fundamentals, essential chords, and rhythmic patterns.
        </p>
      </header>
      ...
      <div className="space-y-8 mb-12 max-w-xl">
        {[
          ...
          { icon: Sparkles, title: 'Technique & troubleshooting', desc: 'Fix common friction points: posture, buzzing frets, and strumming mechanics.', color: 'bg-tertiary-fixed text-on-tertiary-fixed-variant' },
